...
public class MarginPair
{
    ...
    public MarginPair(@JsonProperty("id") final Long id, @JsonProperty("symbol") final String symbol, @JsonProperty("base") final String base, @JsonProperty("quote") final String quote, @JsonProperty("isMarginTrade") final Boolean isMarginTrade, @JsonProperty("isBuyAllowed") final Boolean isBuyAllowed, @JsonProperty("isSellAllowed") final Boolean isSellAllowed) {
        this.id = id;
