...
public class MarginAsset
{
    ...
    public MarginAsset(@JsonProperty("assetFullName") final String assetFullName, @JsonProperty("assetName") final String assetName, @JsonProperty("isBorrowable") final Boolean isBorrowable, @JsonProperty("isMortgageable") final Boolean isMortgageable, @JsonProperty("userMinBorrow") final BigDecimal userMinBorrow, @JsonProperty("userMinRepay") final BigDecimal userMinRepay) {
