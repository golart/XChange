...
public class RepayRecord
{
    ...
    public RepayRecord(@JsonProperty("amount") final BigDecimal amount, @JsonProperty("asset") final String asset, @JsonProperty("interest") final BigDecimal interest, @JsonProperty("principal") final BigDecimal principal, @JsonProperty("status") final String status, @JsonProperty("timestamp") final Long timestamp, @JsonProperty("txId") final Long txId) {
        this.amount = amount;
