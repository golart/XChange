...
public class ShortMarginOrder
{
    ...
    public ShortMarginOrder(@JsonProperty("id") final Long id, @JsonProperty("price") final BigDecimal price, @JsonProperty("qty") final BigDecimal qty, @JsonProperty("quoteQty") final BigDecimal quoteQty, @JsonProperty("symbol") final String symbol, @JsonProperty("time") final Long time) {
        this.id = id;
        this.price = price;
        this.qty = qty;
