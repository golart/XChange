...
public class MarginAssetBalance
{
    ...
    public MarginAssetBalance(@JsonProperty("asset") final String asset, @JsonProperty("borrowed") final BigDecimal borrowed, @JsonProperty("free") final BigDecimal free, @JsonProperty("interest") final BigDecimal interest, @JsonProperty("locked") final BigDecimal locked, @JsonProperty("netAsset") final BigDecimal netAsset) {
