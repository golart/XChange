...
public class ForceLiquidationRec
{
    ...
    public ForceLiquidationRec(@JsonProperty("avgPrice") final BigDecimal avgPrice, @JsonProperty("executedQty") final BigDecimal executedQty, @JsonProperty("orderId") final Long orderId, @JsonProperty("price") final BigDecimal price, @JsonProperty("qty") final BigDecimal qty, @JsonProperty("side") final String side, @JsonProperty("symbol") final String symbol, @JsonProperty("timeInForce") final String timeInForce, @JsonProperty("updatedTime") final Long updatedTime) {
