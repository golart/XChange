...
public class LoanRecord
{
    ...
    public LoanRecord(@JsonProperty("asset") final String asset, @JsonProperty("principal") final BigDecimal principal, @JsonProperty("timestamp") final Long timestamp, @JsonProperty("status") final String status) {
